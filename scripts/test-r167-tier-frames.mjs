...
ok(!/border-image-source\s*:/i.test(all), 'tier UI must not use ornamental border-image frames');
...
ok(!gold.includes('border-image'), 'Gold must not restore filigree framing');
...
ok(!diamond.includes('border-image'), 'Diamond must not restore beveled border-image framing');
