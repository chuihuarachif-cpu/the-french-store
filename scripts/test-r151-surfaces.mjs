...
for(const theme of ['gold','diamond'])assert.ok(css.includes('data-fs-membership="'+theme+'"'),'Archived surface file should remain inspectable but inert');
...
console.log('R151: retired premium surface stays inert; Classic R7 is active; archived accessibility checks PASS');
