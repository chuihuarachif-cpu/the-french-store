...
(() => {
 ...
 const client={from:table=>new Query(table),rpc(name){counters[name]=(counters[name]||0)+1;
  const data={is_admin:false,admin_app_is_allowed:false,get_my_wallet_balance:scenario==='zero'?0:70.30,get_my_loyalty_summary:summary,get_my_loyalty_launch_progress:{program_launched:true,admin_view:false,rewarded_ads_enabled:false},get_my_loyalty_upgrade_quote:{eligible:rank==='gold',charged_bob:8,ends_at:'2026-10-06T12:00:00Z',remaining_days:30},get_my_paid_whatsapp_notice_status:{available:false},get_my_reseller_dashboard:{is_reseller:true,reseller_number:42,rank_level:2,rank_name:'Plata',month_spend:210,next_level_target:300,remaining_to_next:90,order_count:8,lifetime_spend:620,tracked_savings:33.40},get_my_reseller_prices:[{product_id:54,regular_price:20,my_price:18.28,savings:1.72},{product_id:903,regular_price:11,my_price:9.90,savings:1.10}],get_my_referral_state:{active:true,code:'FSQA123456',reward_points_max:300,reward_margin_share:.20,qualifying_min_total:20,hold_hours:168,pending_count:1,qualified_count:2,net_referral_points:400,points_per_bob:100},get_my_rewards_ad_preferences:{enabled:false},get_my_ad_reward_status:{enabled:false}};
