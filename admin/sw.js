...
const CACHE='fs-admin-r223-brand-20260918';
const SHELL=['/admin/','/admin/index.html','/admin/manifest.webmanifest','/v2/assets/brand/icon-192.png','/v2/assets/brand/icon-512.webp'];
