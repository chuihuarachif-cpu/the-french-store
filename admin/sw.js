const CACHE='fs-admin-r89-20260826';
const SHELL=['/admin/','/admin/index.html','/admin/app.css?v=20260826-r89','/admin/r89-auth-fix.js?v=20260826-r89','/admin/app.js?v=20260826-r89','/admin/manifest.webmanifest','/v2/assets/brand/icon-192.png','/v2/assets/brand/icon-512.png'];
