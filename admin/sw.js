const CACHE='fs-admin-r88-20260826';
const SHELL=['/admin/','/admin/index.html','/admin/app.css?v=20260826-r88','/admin/app.js?v=20260826-r88','/admin/manifest.webmanifest','/v2/assets/brand/icon-192.png','/v2/assets/brand/icon-512.png'];
